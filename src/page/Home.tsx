...
export default function Home() {
    return <>
        <div className={"flex items-center justify-center flex-col py-8 sm:pt-8 sm:pb-12 gap-3 text-center"}>
            <img alt="Warren Chemerika, Web Developer | ihawp.com" title="Warren Chemerika, Web Developer | ihawp.com" className="rounded-full w-[225px] h-[225px] hover:bg-green-600 hover:p-5 transition-all mb-2" draggable={"false"} src={"./w.webp"}/>
