...
export default function Roadmap() {
    return <>
        <div className={"sm:flex h-max pb-5 hidden gap-3 w-full text-center text-[#999] text-xs"}>
            <a href={"#2024"} className={"p-1 flex-grow bg-[#999] bg-opacity-20 rounded hover:bg-opacity-30"}>2024</a>
            <a href={"#2025"} className={"p-1 flex-grow bg-[#999] bg-opacity-20 rounded hover:bg-opacity-30"}>2025</a>
            <a href={"#2026"} className={"p-1 flex-grow bg-[#999] bg-opacity-20 rounded hover:bg-opacity-30"}>2026</a>
            <a href={"#2027"} className={"p-1 flex-grow bg-[#999] bg-opacity-20 rounded hover:bg-opacity-30"}>2027</a>
            <a href={"#2028"} className={"p-1 flex-grow bg-[#999] bg-opacity-20 rounded hover:bg-opacity-30"}>2028</a>
            <a href={"#2029"} className={"p-1 flex-grow bg-[#999] bg-opacity-20 rounded hover:bg-opacity-30"}>2029</a>
        </div>
            ...
            <li id="2024">
                ...
                <ul className={"list-none sm:pl-[3.8rem] pl-[2.5rem] flex flex-col gap-5"}>
                    <li className={"flex items-start"}>
                        <FontAwesomeIcon icon={faCircleCheck} className={"h-[30px] w-[20px] sm:mr-5 mr-3 text-green-600"}/>
