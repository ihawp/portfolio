export default function PrivacyPolicy() {
    return <div className="max-w-3xl">
        <h1 className="mb-4 text-3xl justify-center items-center flex h-[100px]"><strong>Privacy Policy</strong></h1>
        <p className="mb-4"><strong>Effective Date:</strong> 2024/11/02</p>
        <p className="mb-4 opacity-90">
            Welcome to <strong>ihawp.com</strong>. Your privacy is important to us. This Privacy Policy outlines how we
        ...
        <p className="mb-4 opacity-90">
            ...
            any other information you submit through contact forms or other features on the Site. We may also collect
        ...
        <ul className="list-disc list-inside mb-4 opacity-90">
            ...
            <li>To send you updates and information about our services, if you have opted to receive such
                communications.
            </li>
        </ul>
        ...
        <p className="mb-4 opacity-90">
            Our Site may use cookies and similar tracking technologies to enhance user experience. Cookies are small
            files placed on your device that help us analyze traffic and remember your preferences. You can manage
        ...
        <p className="mb-2 opacity-90"><strong>Email:</strong> <a href={"mailto:ihawp@ihawp.com"}
                                                                  title={"Email: ihawp@ihawp.com"}
                                                                  className={"underline"}>ihawp@ihawp.com</a></p>
    </div>
};
